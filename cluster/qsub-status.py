...
def handle_hung_qstat(
        jobid, qstat_stdout,
        cpu_hung_min_time=int(cluster_config['cpu_hung_min_time']),
        cpu_hung_max_ratio=int(cluster_config['cpu_hung_max_ratio']),
        debug=False
):
...
def missing_status(
        jobid, reset=False,
        missing_job_wait=float(cluster_config["missing_job_wait"])
):
